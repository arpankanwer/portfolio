...
const String aboutMeDetail =
    "  👋 Greetings! I'm Birarpanjot Singh Kanwer, a dedicated programmer 🌟🚀 who transforms copious amounts of caffeine ☕ into meticulously crafted lines of code 💻. Welcome to my tech-tastic portfolio 🎨, where I merge my lifelong passion for coding ❤️‍🔥 with a newfound admiration for the elegance of iOS 🍎 and Android 🤖 development using Flutter 🐦 and React Native ⚛️ with Expo.\n\n    I have recently completed my three-year advanced diploma 🎓 in Software Development and Network Engineering from Sheridan College 🏫. I have developed several mobile apps 📱, including those published on the 🛒 Play Store.\n\nI also worked at Evertz Microsystems 🖥️ as a Software QA Engineer during Winter 2024 ❄️ and recently, I had contributed to a capstone project 🎯 using ReactJS ⚛️ and React Native with Expo, which won accolades 🏆 for its innovation and execution.";
