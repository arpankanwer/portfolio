          ...
          {testimonials.map((item, idx) => (
            ...
            >
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-700 dark:text-white/80 leading-relaxed italic mb-6">
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-white/10">
                ...
                <p className="text-xs text-slate-500 dark:text-white/50">{item.organization}</p>
              </div>
            </motion.div>
          ))}
        </div>
