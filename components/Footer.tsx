  ...
  return (
    <footer className="border-t border-slate-200 dark:border-white/10 bg-slate-100/70 dark:bg-[#020204] py-16 px-6 sm:px-12 relative overflow-hidden transition-colors">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        {/* Right Socials & Back to Top — liquid glass */}
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/arpankanwer"
            target="_blank"
            rel="noopener noreferrer"
            className="liquid-glass w-10 h-10 rounded-full flex items-center justify-center text-slate-700 dark:text-white/70 cursor-pointer"
          ...
          <button
            onClick={scrollToTop}
            className="liquid-glass-strong w-10 h-10 rounded-full flex items-center justify-center cursor-pointer"
