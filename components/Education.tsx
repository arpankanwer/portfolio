      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-white mb-4">
            Education & <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-cyan">Honors</span>.
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-cyan">
              ...
              <div className="space-y-3.5 bg-white/[0.03] p-5 rounded-2xl border border-white/5 mb-6">
                <div className="flex items-center justify-between">
                  <span className="text-xs sm:text-sm text-white/60">Institution</span>
                  <span className="text-xs sm:text-sm font-semibold text-white">Sheridan College (Oakville, ON)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs sm:text-sm text-white/60">Cumulative GPA</span>
                  <div className="flex items-center gap-1.5">
                    <Star size={14} className="text-yellow-400 fill-yellow-400" />
                    <span className="font-display font-bold text-lg text-white">3.52 / 4.0</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xs sm:text-sm text-white/60">Academic Standing</span>
                  <span className="text-xs sm:text-sm font-medium text-emerald-400">High Academic Standing</span>
                </div>
              </div>
            </div>

            <div className="space-y-2">
              <p className="text-xs uppercase tracking-wider font-bold text-white/40">Core Coursework</p>
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span key={course} className="px-2.5 py-1 rounded-md bg-white/5 text-[11px] text-white/75 font-mono">
                    {course}
                  </span>
                ))}
              </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                <motion.div 
                  ...
                  className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-yellow-400 via-amber-500 to-yellow-600 flex items-center justify-center text-black shadow-[0_0_30px_rgba(234,179,8,0.4)]"
                >
                  <Trophy size={28} className="text-black" />
                </motion.div>
                <span className="px-3 py-1 rounded-full bg-yellow-400/10 border border-yellow-400/30 text-xs font-mono text-yellow-300">
                  Year 2024
                </span>
              </div>
              
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/20 text-cyan text-xs font-mono mb-3">
              ...
              <p className="text-sm sm:text-base text-white/75 leading-relaxed mb-6">
                Awarded top rank among <strong className="text-white">40+ competing engineering teams</strong> for building <strong className="text-white">GigJet</strong>. Recognized by industry judges for superior mobile architecture, real-time communication protocols, clean UI execution, and full-stack reliability.
              </p>
            </div>
            ...
            <div className="relative z-10 pt-4 border-t border-white/10 flex items-center justify-between text-xs text-white/60">
              ...
              <span className="font-mono text-cyan">Top 1 / 40+ Teams</span>
            </div>
          </motion.div>
